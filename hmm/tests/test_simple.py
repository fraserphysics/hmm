...
class TestHMM(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.y_model = hmm.simple.Observation(_py_state.copy(), self.rng)
        self.hmm = hmm.simple.HMM(
...
class TestProb(unittest.TestCase):
    ...
    def setUp(self):
        self.a = hmm.simple.Prob(A_.copy())
        self.b = hmm.simple.Prob(B_.copy())
        self.c = hmm.simple.Prob(C_.copy())
